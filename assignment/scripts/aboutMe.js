...
let lastName = 'Pinataro';
// 3 - Create a third variable called `fullName`, assign it the value of your first and last name
//     (remember, you already have variables for this, can you use those?) (Duckett p78)
...
//      Console log the value of `result`  (On line 26, we previously let adventurous be true...)
let result;
if (adventurous) {
...
//      Console log the value of `diceRoll` (On line 13, luckyNumber is 11...)
...
//      (On line, 36 pets = 0 ; and on line 48, const allowedPets = 2)
let petStatus;
if (pets < allowedPets) {
...
//      (On line 36, pets = 0 ; and on line 41, friendsPets = 2)
let mostPets;
if (pets > friendsPets) {
  mostPets = pets;
} else {
